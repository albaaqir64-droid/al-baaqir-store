  ...
  return (
    <main className="min-h-screen brand-page px-6 py-24">
      <div className="mx-auto max-w-md rounded-[32px] border border-brand-light/20 bg-white p-10 shadow-2xl shadow-brand-dark/5">
        <h1 className="text-3xl font-semibold text-brand-dark">Sign in</h1>
        <p className="mt-3 text-brand-dark/60">Welcome back! Sign in to manage your orders and profile.</p>
        ...
        <p className="mt-8 text-center text-sm text-brand-dark/60">
          ...
          <Link href="/account/register" className="font-semibold text-brand-teal hover:underline">
            Sign up
          </Link>
        </p>
