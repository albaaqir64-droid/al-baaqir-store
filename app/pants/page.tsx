    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        <div className="mb-8 flex items-center justify-between gap-6">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-emerald">Pants</p>
            <h1 className="mt-2 text-3xl font-semibold text-slate-950">Comfortable casual pants</h1>
            <p className="mt-3 text-sm text-slate-600">Lightweight and flexible pants for everyday comfort.</p>
          </div>
