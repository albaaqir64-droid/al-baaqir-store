...
export default async function Page() {
  const data = await fetchProductsByCategory('Pants');
    ...
    <div className="min-h-screen brand-page text-brand-dark">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.3em] text-brand-green">Pants</p>
            <h1 className="mt-4 text-4xl font-semibold tracking-tight text-brand-dark">Comfortable casual pants</h1>
            <p className="mt-3 text-lg text-brand-teal max-w-2xl">Lightweight and flexible pants for everyday comfort.</p>
          </div>
