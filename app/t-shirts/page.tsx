    ...
    <div className="min-h-screen brand-page text-slate-900">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        <div className="mb-8 flex items-center justify-between gap-6">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-emerald">T-Shirts</p>
            <h1 className="mt-2 text-3xl font-semibold text-slate-950">Casual tees with modern prints</h1>
            <p className="mt-3 text-sm text-slate-600">Soft cotton tees, everyday staples in multiple colours.</p>
          </div>
