    ...
    <div className="min-h-screen brand-page text-slate-900">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.3em] text-emerald-500">Women</p>
            <h1 className="mt-4 text-4xl font-semibold tracking-tight text-slate-950">Women&apos;s collection</h1>
            <p className="mt-3 text-lg text-slate-600 max-w-2xl">Elegant bags and belts designed for her.</p>
          </div>
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-24 rounded-[32px] border border-emerald-100 bg-white/50 p-8 backdrop-blur-sm">
              ...
              <div className="mt-8 space-y-8 text-sm">
                <div>
                  <p className="font-bold uppercase tracking-wider text-slate-900 text-[11px]">Style</p>
