  ...
  return (
    <div className="min-h-screen brand-page text-slate-900">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        <div className="mb-12">
          <p className="text-sm font-bold uppercase tracking-[0.3em] text-emerald-500">Karachi Suit</p>
          <h1 className="mt-4 text-4xl font-semibold tracking-tight text-slate-950">Traditional charm with a tailored finish</h1>
          <p className="mt-3 text-lg text-slate-600 max-w-2xl">Shop signature Karachi suit options curated for refined festive and occasion wear.</p>
        </div>
