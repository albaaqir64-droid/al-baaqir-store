    ...
    <div className="min-h-screen brand-page text-slate-900">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.3em] text-emerald-500">New Arrivals</p>
            <h1 className="mt-4 text-4xl font-semibold tracking-tight text-slate-950">Latest additions</h1>
            <p className="mt-3 text-lg text-slate-600 max-w-2xl">Explore the newest pieces added to our collection.</p>
          </div>
