  ...
  return (
    <div className="min-h-screen brand-page text-brand-dark">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        <div className="mb-12">
          <p className="text-sm font-bold uppercase tracking-[0.3em] text-brand-green">Kurti</p>
          <h1 className="mt-4 text-4xl font-semibold tracking-tight text-brand-dark">Elegant kurtis for modern everyday style</h1>
          <p className="mt-3 text-lg text-brand-teal max-w-2xl">Discover breathable tailoring and graceful silhouettes that blend comfort with polish.</p>
        </div>
